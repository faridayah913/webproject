    ...
    <div class="px-4 py-5 my-5  border rounded-3 shadow-lg">
          ...
          <div class="col-lg-6 me-0">
            <div class="col-sm-6">
              ...
              <div>
        <input class="edit w-50 border rounded-3 btn-outline-dark " maxlength="100" value="{{$users->name}}" type="text" name="fullname"></div>
</div><br>

<div class="col-12">
              <label for="email" class="form-label">Email</label>
              <div>
        <input class="edit w-50 border rounded-3 btn-outline-dark" maxlength="100" value="{{$users->email}}" type="email" name="email"></div>
</div><br>
</div>
...
<div class="col-10 col-sm-8 col-lg-6 me-0">
        ...
        <div>
        <input type="radio" name="gender" id="gender_female" value="Female"@if($users->gender=='Female') checked @endif>&nbsp;Female
        <input type="radio" name="gender" id="gender_male" value="Male"@if($users->gender=='Male') checked @endif>&nbsp;Male
...
<div class="col-6">
                ...
                <div>
        <input class="edit w-50 border rounded-3 btn-outline-dark" maxlength="50" value="{{$users->birthday}}" type="date" name="birthday">
</div>
</div><br>
</div>
