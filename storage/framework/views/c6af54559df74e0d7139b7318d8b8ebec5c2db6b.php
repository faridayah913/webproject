...
<link href="css/navbars.css" rel="stylesheet">
    ...
    <div class="container bg-light mx-auto">
        ...
        <form action = "userdelete?rid=<?php echo e($users->id); ?>" method="post">
    <?php echo csrf_field(); ?>
        ...
        <div id="text" class=" p-4 p-md-5 w-50% border rounded-5 bg-light text-dark position-fixed top-50 start-50 translate-middle shadow" >
          ...
          <div class="modal-footer flex-column border-top-0 ">
            ...
            <button class="btn btn-lg btn-outline-warning w-100 mx-0 mb-2" type="button" onclick="window.location='/userview?rid=<?php echo e($users->id); ?>'">Cancel</button>
          </div>
          </div>
      </div>
...
<?php echo e(View::make('footer')); ?><?php /**PATH C:\xampp\htdocs\finalproject\resources\views/userdelete.blade.php ENDPATH**/ ?>