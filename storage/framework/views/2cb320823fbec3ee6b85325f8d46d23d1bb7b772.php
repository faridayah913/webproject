...
<link rel="stylesheet" href="css/heroes.css" >    
    ...
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form action="/register" method="post" class="p-4 p-md-5 border rounded-3 bg-light"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\finalproject\resources\views/register.blade.php ENDPATH**/ ?>