    ...
    <div class="container bg-light mx-auto">
        ...
        <div id="text" class=" p-4 p-md-5 w-50% border rounded-5 bg-light text-dark position-fixed top-50 start-50 translate-middle shadow" >
          ...
          <div class="modal-footer flex-column border-top-0 ">
            ...
            <button type="submit" action="/deleteprofile" class="btn btn-lg btn-warning w-100 mx-0 mb-2">Delete</button>
...
<?php echo e(View::make('footer')); ?><?php /**PATH C:\xampp\htdocs\finalproject\resources\views/deleteprofile.blade.php ENDPATH**/ ?>